...
import com.hunre.dh10c6.yogaone.Adapter.StudentAdapter;
...
//        main_content = findViewById(R.id.main_content);
        ...
        if(!isConflict){
            ...
            classRecomment.setText("Click vào nút bên dưới để có thể về đội của chúng tôi❗");
